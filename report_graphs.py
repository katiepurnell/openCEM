...
# python msolve.py 1_test_bau.cfg -t --solver=gurobi & python msolve.py 1_test_evs_dumb.cfg -t --solver=gurobi & python msolve.py 1_test_evs_smart_0fit.cfg -t --solver=gurobi & python msolve.py 1_test_evs_smart_100fit.cfg -t --solver=gurobi & python msolve.py 1_test_evs_smart_reward_100.cfg -t --solver=gurobi & python msolve.py 1_test_evs_smart_reward_500.cfg -t --solver=gurobi & python msolve.py 1_test_evs_v2g_0fit.cfg -t --solver=gurobi & python msolve.py 1_test_evs_v2g_100fit.cfg -t --solver=gurobi & python msolve.py 1_test_bau_aemo_evs_load.cfg -t --solver=gurobi & python msolve.py 1_test_evs_smart_25fit.cfg -t --solver=gurobi & python msolve.py 1_test_evs_smart_50fit.cfg -t --solver=gurobi & python msolve.py 1_test_evs_smart_200fit.cfg -t --solver=gurobi  & python msolve.py 1_test_evs_smart_reward_50.cfg -t --solver=gurobi & python msolve.py 1_test_evs_smart_reward_200.cfg -t --solver=gurobi & python msolve.py 1_test_evs_v2g_25fit.cfg -t --solver=gurobi & python msolve.py 1_test_evs_v2g_50fit.cfg -t --solver=gurobi & python msolve.py 1_test_evs_v2g_200fit.cfg -t --solver=gurobi & python report_graphs.py
